      ...
      <!--header section -->
            <header class="top-header">
                  <div class="container-fluid">
                        <div class="row">
                              ...
                              <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a class="menu active" href="aboutus">About Us </a></li>
                  ...
                  <div class="aboutus">
                        ...
                        jadwal praktik dokter hingga kontak yang dapat dihubungi sewaktu-waktu ketika sakit.</p>
                  </div>
      </body>
</html>
