              ...
              <form method="POST" action="{{ url('alat') }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="id_staf" class="form-control" id="inputIdStaf" placeholder=""name="id_staf">
                  ...
                  <div class="form-group">
                    ...
                    <input type="nama_alat" class="form-control" id="inputNamaAlat" placeholder="" name="nama_alat">
                  ...
                  <div class="form-group">
                    ...
                    <input type="jenis_alat" class="form-control" id="inputJenisAlat" placeholder="" name="jenis_alat">
                  ...
                  <div class="form-group">
                    ...
                    <input type="harga_alat" class="form-control" id="inputHargaAlat" placeholder="" name="harga">
                  ...
                  <div class="form-group">
                    ...
                    <input type="jml_alat" class="form-control" id="inputJmlAlat" placeholder="" name="jumlah">
